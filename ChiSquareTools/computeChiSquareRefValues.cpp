...
void process(const std::vector<std::string>& inputFiles, const std::string& outputFile) {
 ...
 /* int   m_MC_imot2[m_MCs_MAX];
  ...
  //TH1* h_hadronicWMass_wrong = new TH1F("w_mass_wrong", "hadronic w mass (wrong selection)", 70, 30, 140);
  //TH1* h_hadronicTopMass_wrong = new TH1F("hadronic_top_mass_wrong", "hadronic top mass (wrong selection)", 100, 100, 300);
