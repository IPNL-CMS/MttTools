...
void BkgVsTTBDTReader::setupVariables() {
  ...
  m_reader->AddVariable("neutrino_hadronic_first_jet_delta_R", &neutrino_hadronic_first_jet_delta_R);
  ...
  m_reader->AddVariable("lepton_hadronic_first_jet_delta_R", &lepton_hadronic_first_jet_delta_R);
  ...
  m_reader->AddVariable("leptonic_B_hadronic_first_jet_delta_R", &leptonic_B_hadronic_first_jet_delta_R);
  m_reader->AddVariable("leptonic_B_hadronic_second_jet_delta_R", &leptonic_B_hadronic_second_jet_delta_R);
  m_reader->AddVariable("hadronic_B_hadronic_first_jet_delta_R", &hadronic_B_hadronic_first_jet_delta_R);
