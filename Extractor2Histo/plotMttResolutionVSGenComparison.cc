...
void plotMttResolutionVSGenComparison() {
  ...
  TGraphErrors * mtt_resolution_four_jets = (TGraphErrors*) _file0->Get("mtt_gen_vs_mtt_reso_four_jets_chi2sel/mtt_gen_vs_mtt_reso_four_jets_chi2sel_resolution");
  ...
  mtt_resolution_four_jets->SetTitle("");
  mtt_resolution_four_jets->GetYaxis()->SetTitle("Resolution");
  mtt_resolution_four_jets->GetXaxis()->SetTitle("m_{t#bar{t}}^{gen} (GeV)");
  mtt_resolution_four_jets->SetLineColor(TColor::GetColor("#542437"));
  mtt_resolution_four_jets->SetLineColor(TColor::GetColor("#8A9B0F"));
  //mtt_resolution_four_jets->SetLineColor(TColor::GetColor("#C02942"));
  mtt_resolution_four_jets->SetMarkerColor(mtt_resolution_four_jets->GetLineColor());
  mtt_resolution_four_jets->SetMarkerStyle(20);
  mtt_resolution_four_jets->SetMarkerSize(1.5);
  ...
  l.AddEntry(mtt_resolution_four_jets, "four leading jets", "P");
  l.Draw("same");

  gPad->Modified();
  gPad->Update();

  c->Print("mtt_resolution_vs_gen_comparison.pdf");
}
