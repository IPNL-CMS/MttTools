...
void plotMttResponseVSGenComparison() {
  ...
  TGraphErrors * mtt_response_four_jets = (TGraphErrors*) _file0->Get("mtt_gen_vs_mtt_reco_four_jets_chi2sel/mtt_gen_vs_mtt_reco_four_jets_chi2sel_response");
  mtt_response_four_jets->SetTitle("");
  mtt_response_four_jets->GetYaxis()->SetTitle("m_{t#bar{t}} (GeV)");
  mtt_response_four_jets->GetXaxis()->SetTitle("m_{t#bar{t}}^{gen} (GeV)");
  //mtt_response_four_jets->SetLineColor(TColor::GetColor("#542437"));
  mtt_response_four_jets->SetLineColor(TColor::GetColor("#8A9B0F"));
  //mtt_response_four_jets->SetLineColor(TColor::GetColor("#C02942"));
  mtt_response_four_jets->SetMarkerColor(mtt_response_four_jets->GetLineColor());
  mtt_response_four_jets->SetMarkerStyle(20);
  mtt_response_four_jets->SetMarkerSize(1.5);
  ...
  mtt_response_four_jets->Fit(line_b, "QN");
  line_b->SetLineColor(mtt_response_four_jets->GetLineColor());
  line_b->SetLineWidth(2);
  
  TMultiGraph* mg = new TMultiGraph();

  mg->Add(mtt_response, "P");
  mg->Add(mtt_response_four_jets, "P");

  mg->Draw("a");

  mg->GetYaxis()->SetTitle("m_{t#bar{t}} (GeV)");
  ...
  l.AddEntry(mtt_response_four_jets, "four leading jets", "P");
  l.Draw("same");

  gPad->Modified();
  gPad->Update();

  c->Print("mtt_response_vs_gen_comparison.pdf");
}
