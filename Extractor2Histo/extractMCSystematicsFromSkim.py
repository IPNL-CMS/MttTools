...
files = [
        ...
        # Signal Z'
        ["Signal_ZPrimeToTTJets_M500GeV_W50GeV_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M500GeV_W50GeV_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M750GeV_W75GeV_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M750GeV_W75GeV_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M1000GeV_W100GeV_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M1000GeV_W100GeV_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M1250GeV_W125GeV_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M1250GeV_W125GeV_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M1500GeV_W150GeV_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M1500GeV_W150GeV_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M2000GeV_W200GeV_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M2000GeV_W200GeV_skims_%s.root"],

        ["Signal_ZPrimeToTTJets_M500GeV_W50GeV_ext_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M500GeV_W50GeV_ext_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M750GeV_W75GeV_ext_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M750GeV_W75GeV_ext_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M1000GeV_W100GeV_ext_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M1000GeV_W100GeV_ext_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M1250GeV_W125GeV_ext_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M1250GeV_W125GeV_ext_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M1500GeV_W150GeV_ext_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M1500GeV_W150GeV_ext_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M2000GeV_W200GeV_ext_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M2000GeV_W200GeV_ext_skims_%s.root"],

        ["Signal_ZPrimeToTTJets_M500GeV_W5GeV_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M500GeV_W5GeV_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M750GeV_W7p5GeV_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M750GeV_W7p5GeV_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M1000GeV_W10GeV_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M1000GeV_W10GeV_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M1250GeV_W12p5GeV_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M1250GeV_W12p5GeV_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M1500GeV_W15GeV_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M1500GeV_W15GeV_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M2000GeV_W20GeV_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M2000GeV_W20GeV_skims_%s.root"],

        ["Signal_ZPrimeToTTJets_M500GeV_W5GeV_ext_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M500GeV_W5GeV_ext_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M750GeV_W7p5GeV_ext_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M750GeV_W7p5GeV_ext_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M1000GeV_W10GeV_ext_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M1000GeV_W10GeV_ext_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M1250GeV_W12p5GeV_ext_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M1250GeV_W12p5GeV_ext_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M1500GeV_W15GeV_ext_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M1500GeV_W15GeV_ext_skims_%s.root"],
        ["Signal_ZPrimeToTTJets_M2000GeV_W20GeV_ext_histos_%s.root", "skims/%s/Systematics/Signal_ZPrimeToTTJets_M2000GeV_W20GeV_ext_skims_%s.root"],
